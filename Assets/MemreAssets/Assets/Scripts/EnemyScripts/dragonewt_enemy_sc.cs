...
public class dragonewt_enemy_sc : MonoBehaviour , IEnemy
{
    ...
    public void Start()
    {
        ...
        float bitedamage = GetComponentsInChildren<ColliderApplyDamage>()[0].damageAmount = biteDamage;
        normalSightRange = sightRange;
        doubledSightRange = sightRange * 2;
        handhitbox = GetComponentsInChildren<SphereCollider>()[1];
        biteHitbox = GetComponentsInChildren<SphereCollider>()[0];
