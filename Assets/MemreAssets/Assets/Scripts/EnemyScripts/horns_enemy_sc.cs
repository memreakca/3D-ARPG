...
public class horns_enemy_sc : MonoBehaviour , IEnemy
{
    ...
    public void Start()
    {
        ...
        float hnddmg = GetComponentsInChildren<ColliderApplyDamage>()[0].damageAmount = handdamage;
        float bitedamage = GetComponentsInChildren<ColliderApplyDamage>()[1].damageAmount = biteDamage;
        normalSightRange = sightRange;
        doubledSightRange = sightRange * 2;
        handhitbox = GetComponentsInChildren<SphereCollider>()[0];
        biteHitbox = GetComponentsInChildren<SphereCollider>()[1];
